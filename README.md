...
| 13 февраля | Семинар 01 |  <ul><li>Backpropagation</li><li>Batchnorm</li><li>Dropout</li></ul> | [Автоград](./Seminars/02-autograd/notes.ipynb) |  [Полносвязная нейронная сеть на numpy]() |
