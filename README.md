...
| 13 февраля | Лекция  02 | Регуляризация | [Конспект](./Seminars/03-regularization/notes.ipynb) | [Полносвязная нейронная сеть на numpy](https://github.com/mmp-practicum-team/mmp_dl_spring_2025/blob/main/Tasks/task1/task_01.ipynb) |
