...
| 13 февраля | Семинар 01 |  <ul><li>Backpropagation</li><li>Batchnorm</li><li>Dropout</li></ul> | ¯\\\_(ツ)\_/¯ |  [Полносвязная нейронная сеть на numpy]() |
...
* Не знание ответа на **любой вопрос** из теоретического минимума означает оценку **неудовлетворительно**
...
* Во время ответа по билету нельзя пользоваться заранее подготовленными материалами, все необходимое должно быть в письменном ответе
