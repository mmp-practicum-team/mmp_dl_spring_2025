...
| 17 февраля | Лекция  03 | Оптимизаторы | [Конспект](./Seminars/04-optimizers/Оптимизация_в_DL.ipynb) | ¯\\\_(ツ)\_/¯ |
| 20 февраля | Семинар 02 | PyTorch | [Конспект](./Seminars/04-optimizers/Основы_Pytorch.ipynb) | [Простейшая нейронная сеть на Pytorch](./Tasks/task1_5/task_01.5_empty.ipynb) |
...
| 4 марта    | Семинар 04 | <ul><li>Семантическая сегментация</li><li>Transposed Convolution</li></ul>  | ¯\\\_(ツ)\_/¯ | [Сегментация изображений]() |
